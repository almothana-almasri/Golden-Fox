...
- change `Products` folder to the app name of your choice
- Search through entire code base for `Product`,`Products` and `Products` to modify code to use your resource
  - `project/settings.py`
  - `project/urls.py`
  - App's files
    - `views.py`
...
- Update ProductModel with fields you need
